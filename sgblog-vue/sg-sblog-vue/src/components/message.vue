...
<!--            <div style="height: 100px;width: 100px;" >111-->
<!--              <img :src="urll" alt="">-->
<!--            </div>-->
            <form class=""  >
                <el-input
...
<!--                                <img src="../../static/img/emot/image/weixiao.gif" alt="">-->
                                <img :src="require('../../static/img/emot/image/'+oitem.url)" alt="">
                            </li>
                        </ul>
                        <div class="OwO-bar">
    ...
    export default {
        data() { //选项 / 数据
            return {
                ...
                sendTip:'发送~',
                // urll: require("../../static/img/emot/image/weixiao.gif"),
                // urll: "../../static/img/emot/image/weixiao.gif",
                OwOlist:[//表情包和表情路径
        ...
        methods: { //事件处理器
          ...
          showCommentList: function(initData){//评论列表
              ...
              if(that.$route.name=='DetailArticle'){//文章列表的评论
                  that.type = 0;
                that.queryParams = { ...that.queryParams, commentType: that.type };
                console.log('看这里---------------------',this.queryParams)
