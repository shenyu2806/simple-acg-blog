...
<div class="">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg.jpg)'}">
		...
		<div class="h-information">
                    ...
                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/tx.png'" alt="">

			<h2 class="h-description">

                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:" 神月的博客前台，让你遨游知识海洋"}}
...
export default {
	...
	mounted() { //页面元素加载完成
      ...
      console.log('111111',that.$store.state.themeObj)
